    ...
    <div className="home-content">
      ...
      <div className='playlists-area' style={{ display: playlistAreaDisplay }}>
        <div className="search-results-area">
          ...
          <p className="desktop-description">You can listen to this previews of the songs, and if you like it - to add to your own Spotify playlist by clicking on plus button. Your playlist will appear at the rigth of the app.</p>
          <p className="mobile-description">You can listen to this previews of the songs, and if you like it - to add to your own Spotify playlist by clicking on plus button. Your playlist will appear at the bottom of the app.</p>          <SearchResults results={props.resultArray} onAddTrack={addTrack} token={props.token} />
        </div>
